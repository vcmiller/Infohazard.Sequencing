# Sequencing: A system for creating startup and level loading sequences, as well as saving game state.
...
4. Paste in `https://github.com/vcmiller/Infohazard.Sequencing.git`.
5. Click Add.
...
2. Using your preferred git client or the command line, add `https://github.com/vcmiller/Infohazard.Sequencing.git` as a submodule in your project's Packages folder.
